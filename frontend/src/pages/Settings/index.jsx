      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
        ...
        {instances.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 text-sm">Clique em "Conectar novo número" para escanear o QR Code.</p>
          </div>
        ) : (
              ...
              return (
                <div key={inst.id} className="flex items-center justify-between p-4 bg-gray-800 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-0.5">{inst.phone ?? inst.instance_id}</p>
                    {inst.connected_at && (
